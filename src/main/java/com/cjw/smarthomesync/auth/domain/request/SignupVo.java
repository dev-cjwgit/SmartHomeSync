...
public class SignupVo {
    ...
    @Pattern(regexp = "^[ㄱ-ㅎ가-힣a-z0-9-_]{2,20}$", groups = {ValidationGroups.signup.class}, message = "닉네임은 특수 문자를 제외한 2~20자리 여야 합니다.")
    private String name;

    @Pattern(regexp = "^[ㄱ-ㅎ가-힣a-z0-9-_]{2,10}$", groups = {ValidationGroups.signup.class}, message = "닉네임은 특수 문자를 제외한 2~10자리 여야 합니다.")
